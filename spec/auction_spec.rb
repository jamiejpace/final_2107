...
RSpec.describe Auction do
  ...
  it 'lists popular items' do
    ...
    expect(auction.popular_items).to eq([item1, item4])
  end

  it 'reports potential revenue' do
    item1 = Item.new('Chalkware Piggy Bank')
    item2 = Item.new('Bamboo Picture Frame')
    item3 = Item.new('Homemade Chocolate Chip Cookies')
    item4 = Item.new('2 Days Dogsitting')
  ...
  it 'has a date that is the date the auction was created on' do
    auction = Auction.new

    expect(auction.date).to eq("11/08/2021")
  end

  it 'has a date that is the date in the past' do
    auction = Auction.new
  ...
  xit 'closes the auction' do
    ...
    expect(auction.close_auction).to eq({item1 => attendee1, item2 => "Not Sold", item3 => attendee2, item4 => attendee3, item5 => attendee1})
  end
